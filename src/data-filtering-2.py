...
FEW_SHOT = [
    {
        "problem": "Ava is planning a camping trip with her friends...",
        "generated_solution": "There will be 5 people... Each needs 3 bars/day... 5×9 = 45...",
        "include": True
    },
    {
        "problem": "In base $b$, there are exactly one hundred three-digit numbers...",
        "generated_solution": "We solve using factorials and base logic... b^3 - 2b^2 + b + 1 = 0...",
        "include": False
    }
]
